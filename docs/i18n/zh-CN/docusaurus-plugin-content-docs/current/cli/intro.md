...
[![npm version](https://badge.fury.io/js/%40musistudio%2Fclaude-code-router.svg)](https://www.npmjs.com/package/@hafez/claude-code-router)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Node Version](https://img.shields.io/node/v/@hafez/claude-code-router.svg)
...
# 或
pnpm add -g @hafez/claude-code-router
# 或
yarn global add @hafez/claude-code-router
```
...
- **CLI** (`@hafez/claude-code-router`): 提供 `ccr` 命令的命令行工具
